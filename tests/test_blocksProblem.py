...
from TheBlocksProblem.BlocksProblem import BlocksProblem
import filecmp


class TestBlocksProblem(TestCase):
    def test_case_simple(self):
        input_file_name = "TheBlocksProblem/TestCases.txt"
        output_file_name = "TheBlocksProblem/output.txt"
        expect_file_name = "TheBlocksProblem/expect.txt"
